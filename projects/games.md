...
Customers enter the cinema → join a queue → are assigned seats → navigate using AI movement → complete a movie session → generate income → and feed into the upgrade system.
...
![Cinema Rush Screenshot](/screenshots/games/CinemaRush.png)

---

## 🔗 Play the Game

👉 [Try Cinema Rush on itch.io](https://jayforge.itch.io/cinema-rush)

---

## 🧪 Learning Projects

### Multiplayer Kitchen Chaos (Unity Tutorial – Learning Project)
...
👉 GitHub: [Kitchen Chaos](https://github.com/jayforge-dev/unity-tutorial-kitchenchaos-multiplayer)
